...
- `step_normalize()`: Normalizes numeric predictors
= `update_role()`: Adds metadata to recipe
...
cluster_grid <- grid_regular(num_clusters(), levels = 5)
...
final_kmeans <- finalize_model(kmeans_spec_tune, best_kmeans)
