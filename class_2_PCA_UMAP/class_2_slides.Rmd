...
|----------|----------------|-------|
| Loadings | U (left singular matrix) | Contribution of each feature to each component |
| Scores | Scaled U | Projected samples on each principal component |
| Eigenvalues | S^2 | Variance explained by each component |
| Rotation | V^T (right singular matrix) | Samples in rotated coordinate system |
...
| PCA | Loadings | Scores or rotation | Eigenvalues |
